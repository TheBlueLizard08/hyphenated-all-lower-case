...
public class Utility : ScriptableObject
{
	...
	#region Quaternion hell
	
	public static Vector3 NegateRotation(Vector3 _euler)
	{
		return new Vector3(
			_euler.x > 180 ? _euler.x - 360 : _euler.x,
			_euler.y > 180 ? _euler.y - 360 : _euler.y,
			_euler.z > 180 ? _euler.z - 360 : _euler.z);
	}

	public static float NegateRotation(float _angle)
	{
